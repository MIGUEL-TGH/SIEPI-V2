...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-10-2025 a las 06:49:24
...
--
-- Base de datos: `siepi_v2`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `afromexicana_por_municipio_v2`
--

CREATE TABLE `afromexicana_por_municipio_v2` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `afromexicana_por_municipio_v2`
--

INSERT INTO `afromexicana_por_municipio_v2` (`id`, `Id_Mun`, `Genero`, `A`, `B`, `C`, `D`, `E`, `F`, `G`, `H`, `I`, `J`, `K`, `L`, `M`, `N`, `P`, `O`, `Q`, `R`, `S`) VALUES
(1, 100, 'H', '*', '*', '*', '2', '*', '3', '1', '*', '1', '*', '*', '*', '*', '*', '*', '*', '*', '*', '*'),
...
--
-- Estructura de tabla para la tabla `cultura_por_municipio_v2`
--

CREATE TABLE `cultura_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `cultura_por_municipio_v2`
--

INSERT INTO `cultura_por_municipio_v2` (`Id`, `Id_Mun`, `Tradiciones`, `EIC`, `CC`, `Museos`, `Bibliotecas`, `Auditorios`, `CD`, `PPA`) VALUES
...
--
-- Estructura de tabla para la tabla `economia_por_municipio_v2`
--

CREATE TABLE `economia_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `economia_por_municipio_v2`
--

INSERT INTO `economia_por_municipio_v2` (`Id`, `Id_Mun`, `GMM`, `Poblacion`, `PM`, `PE`, `ACEAAFPC`, `C_Menor`, `C_Mayor`, `Ind_M`, `SATPAB`, `Otros`, `Micro`, `Pequenia`, `Mediana`, `Grande`, `PO`, `PD`, `Fecha`) VALUES
...
--
-- Estructura de tabla para la tabla `educacion_por_municipio_v2`
--

CREATE TABLE `educacion_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `educacion_por_municipio_v2`
--

INSERT INTO `educacion_por_municipio_v2` (`Id`, `Id_Mun`, `RS`, `TCTM`, `CAM`, `Secundarias`, `Primarias`, `Preescolares`, `EATECS`, `IA`, `PIM`, `PIM_`) VALUES
...
--
-- Estructura de tabla para la tabla `fuentes_informacion_v2`
--

CREATE TABLE `fuentes_informacion_v2` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `fuentes_informacion_v2`
--

INSERT INTO `fuentes_informacion_v2` (`id`, `id_mod`, `desc_`, `link`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `gobernanza_por_municipio_v2`
--

CREATE TABLE `gobernanza_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `gobernanza_por_municipio_v2`
--

INSERT INTO `gobernanza_por_municipio_v2` (`Id`, `Id_Mun`, `PH`, `PM`, `SH`, `SM`, `RH`, `RM`, `IASC`) VALUES
(1, 100, '1', '0', '0', '1', '3', '5', '0'),
(2, 213, '1', '0', '0', '1', '3', '5', '0'),
(3, 111, '1', '0', '0', '1', '5', '3', '2'),
(4, 178, '1', '0', '0', '1', '4', '4', '0'),
...
--
-- Estructura de tabla para la tabla `infraestructura_por_municipio_v2`
--

CREATE TABLE `infraestructura_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `infraestructura_por_municipio_v2`
--

INSERT INTO `infraestructura_por_municipio_v2` (`Id`, `Id_Mun`, `TV`, `AV`, `EV`, `DV`, `CCEV_2020`) VALUES
...
--
-- Estructura de tabla para la tabla `justicia_seguridad_por_municipio_v2`
--

CREATE TABLE `justicia_seguridad_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `justicia_seguridad_por_municipio_v2`
--

INSERT INTO `justicia_seguridad_por_municipio_v2` (`Id`, `Id_Mun`, `ICJI`, `DVF_2022`, `DVGTSDVF_2022`, `BE`, `BC`, `TP`, `Ejidos`, `Comunidades`, `NA`) VALUES
...
--
-- Estructura de tabla para la tabla `lenguas_por_municipio_v2`
--

CREATE TABLE `lenguas_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `lenguas_por_municipio_v2`
--

INSERT INTO `lenguas_por_municipio_v2` (`Id`, `Id_Mun`, `Lenguas`, `IPPIH`, `PTICMAJ`) VALUES
...
--
-- Estructura de tabla para la tabla `lenguas_v2`
--

CREATE TABLE `lenguas_v2` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `lenguas_v2`
--

INSERT INTO `lenguas_v2` (`id`, `nombre`, `icono`) VALUES
...
--
-- Estructura de tabla para la tabla `lengua_por_municipio_v2`
--

CREATE TABLE `lengua_por_municipio_v2` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `lengua_por_municipio_v2`
--

INSERT INTO `lengua_por_municipio_v2` (`id`, `idmunicipio`, `idlengua`, `nhablantes`) VALUES
(1, 57, 7, 83),
(2, 64, 7, 1715),
(3, 86, 7, 917),
(4, 100, 7, 9859),
...
--
-- Estructura de tabla para la tabla `login_v2`
--

CREATE TABLE `login_v2` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `login_v2`
--

INSERT INTO `login_v2` (`id`, `id_user`, `token`, `token_exp`, `date_created`, `time_created`, `status`) VALUES
(1, 1, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MjgzNDE3MDIsImV4cCI6MTcyODM1NjEwMiwiZGF0YSI6eyJpZCI6IjEiLCJuYW1lIjoiVW5pZGFkIGRlIERlc2Fycm9sbG8gZGUgVGVjbm9sb2dcdTAwZWRhcyBkZSBsYSBJbmZvcm1hY2lcdTAwZjNuIiwiaW1nIjoibXVsdGltZWRpYS9pbWcvdXNlcnMvMDAwMDAxLmpwZyIsInBhc3MiOiIxIn19.o63Vk5kiWr5u0Lqheqg4dODY8kLOkZ2SvHucBOXUuH0', '1728356102', '2024-10-07', '16:55:02', 0),
(2, 1, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3Mjg0MDMwMTEsImV4cCI6MTcyODQxNzQxMSwiZGF0YSI6eyJpZCI6IjEiLCJuYW1lIjoiVW5pZGFkIGRlIERlc2Fycm9sbG8gZGUgVGVjbm9sb2dcdTAwZWRhcyBkZSBsYSBJbmZvcm1hY2lcdTAwZjNuIiwiaW1nIjoibXVsdGltZWRpYS9pbWcvdXNlcnMvMDAwMDAxLmpwZyIsInBhc3MiOiIxIn19.9n8v6XCNdHNev-BP_eQTZcYaZCCBNrX3S7KB9ziJqmY', '1728417411', '2024-10-08', '09:56:51', 0),
(3, 1, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MzE1MzI5OTcsImV4cCI6MTczMTU0NzM5NywiZGF0YSI6eyJpZCI6IjEiLCJuYW1lIjoiVW5pZGFkIGRlIERlc2Fycm9sbG8gZGUgVGVjbm9sb2dcdTAwZWRhcyBkZSBsYSBJbmZvcm1hY2lcdTAwZjNuIiwiaW1nIjoibXVsdGltZWRpYS9pbWcvdXNlcnMvMDAwMDAxLmpwZyIsInBhc3MiOiIxIn19.Fm3DQWIwBUTOtS9VcWfnTHt4Pfefa1ZgUw7YWa5krAw', '1731547397', '2024-11-13', '15:23:16', 0),
(4, 1, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MzUwMDA4MjAsImV4cCI6MTczNTAxNTIyMCwiZGF0YSI6eyJpZCI6IjEiLCJuYW1lIjoiVW5pZGFkIGRlIERlc2Fycm9sbG8gZGUgVGVjbm9sb2dcdTAwZWRhcyBkZSBsYSBJbmZvcm1hY2lcdTAwZjNuIiwiaW1nIjoibXVsdGltZWRpYS9pbWcvdXNlcnMvMDAwMDAxLmpwZyIsInBhc3MiOiIxIn19.zCO2SxRpYC8BrCkxTUgj0tm9Yobc5BtEvnBteTjdpOs', '1735015220', '2024-12-23', '18:40:19', 0),
(5, 1, 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MzUwMDEwMTksImV4cCI6MTczNTAxNTQxOSwiZGF0YSI6eyJpZCI6IjEiLCJuYW1lIjoiVW5pZGFkIGRlIERlc2Fycm9sbG8gZGUgVGVjbm9sb2dcdTAwZWRhcyBkZSBsYSBJbmZvcm1hY2lcdTAwZjNuIiwiaW1nIjoibXVsdGltZWRpYS9pbWcvdXNlcnMvMDAwMDAxLmpwZyIsInBhc3MiOiIxIn19.AKfeGVGnPKWT6kHa8DEU4HNGeG3lREGgix8BhgGv7Ws', '1735015419', '2024-12-23', '18:43:38', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `medio_ambiente_por_municipio_v2`
--

CREATE TABLE `medio_ambiente_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `medio_ambiente_por_municipio_v2`
--

INSERT INTO `medio_ambiente_por_municipio_v2` (`Id`, `Id_Mun`, `ICM`, `TMA`, `IPA`, `TS`, `US`, `ITR`, `ITV`, `RH`, `Cuenca`, `Subcuenca`, `CA`, `C_A`, `I_F`, `TH`, `Herbaceo`, `Harboreo`, `Arbustivo`, `ITC`) VALUES
...
--
-- Estructura de tabla para la tabla `migracion_por_municipio_v2`
--

CREATE TABLE `migracion_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `migracion_por_municipio_v2`
--

INSERT INTO `migracion_por_municipio_v2` (`Id`, `Id_Mun`, `IGIM`, `IGIM_2010`, `IGIM_2020`, `PFNOE`, `PMNOE`, `VT`, `VRR`, `ICR_2022`) VALUES
...
--
-- Estructura de tabla para la tabla `modules_v2`
--
...
--
-- Volcado de datos para la tabla `modules_v2`
--

INSERT INTO `modules_v2` (`id`, `description`, `component`, `uri`, `icon`, `color`, `team`, `place`, `map`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `municipios_v2`
--

CREATE TABLE `municipios_v2` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `municipios_v2`
--

INSERT INTO `municipios_v2` (`id`, `region`, `nombre`, `latitud`, `longitud`, `icono`, `TipoMunicipio`, `estatus`, `detalles`) VALUES
...
--
-- Estructura de tabla para la tabla `pages_v2`
--
...
--
-- Volcado de datos para la tabla `pages_v2`
--

INSERT INTO `pages_v2` (`id`, `name`) VALUES
(1, 'main'),
(2, 'map'),
(3, '¿Qué es el SIEPI?'),
(4, 'Postales'),
...
--
-- Estructura de tabla para la tabla `pruebas_v2`
--

CREATE TABLE `pruebas_v2` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL,
  `desc_` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
-- Estructura de tabla para la tabla `regiones_v2`
--

CREATE TABLE `regiones_v2` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `regiones_v2`
--

INSERT INTO `regiones_v2` (`id`, `numero`, `nombre`, `sede`, `latitud`, `longitud`, `icono`, `estatus`, `enlace`, `detalles`, `img`, `video`, `audio`, `tradiciones`) VALUES
...
--
-- Estructura de tabla para la tabla `salud_por_municipio_v2`
--

CREATE TABLE `salud_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `salud_por_municipio_v2`
--

INSERT INTO `salud_por_municipio_v2` (`Id`, `Id_Mun`, `Poblacion`, `NH`, `NM`, `MH`, `MM`, `NE`, `CE`, `HG`, `HE`, `CSS`, `SSS`, `Otros`, `PMISPS`, `CTSC`, `PCASS`) VALUES
...
--
-- Estructura de tabla para la tabla `sub_modules_v2`
--

CREATE TABLE `sub_modules_v2` (
  `id` int(11) NOT NULL,
  `id_mod` int(11) NOT NULL,
  `description` text DEFAULT NULL,
  `component` text DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `sub_modules_v2`
--

INSERT INTO `sub_modules_v2` (`id`, `id_mod`, `description`, `component`, `icon`, `color`, `search`, `id_search`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `tecnologia_por_municipio_v2`
--

CREATE TABLE `tecnologia_por_municipio_v2` (
  `Id` int(11) NOT NULL,
  `Id_Mun` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `tecnologia_por_municipio_v2`
--

INSERT INTO `tecnologia_por_municipio_v2` (`Id`, `Id_Mun`, `ICHIGP`, `PWGCT`, `DOR`, `Televisor`, `CLT`, `LTF`, `TC`, `STP`, `SPMV`, `CV`) VALUES
...
--
-- Estructura de tabla para la tabla `tiposmunicipios_v2`
--

CREATE TABLE `tiposmunicipios_v2` (
  `id` int(11) NOT NULL,
  `nombre` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

--
-- Volcado de datos para la tabla `tiposmunicipios_v2`
--

INSERT INTO `tiposmunicipios_v2` (`id`, `nombre`) VALUES
(1, 'Indígena'),
...
--
-- Estructura de tabla para la tabla `users_v2`
--
...
--
-- Volcado de datos para la tabla `users_v2`
--

INSERT INTO `users_v2` (`id`, `name`, `email`, `password`, `img`, `update_pass`, `status`) VALUES
...
--
-- Estructura de tabla para la tabla `user_permissions_v2`
--
...
--
-- Volcado de datos para la tabla `user_permissions_v2`
--

INSERT INTO `user_permissions_v2` (`id`, `id_user`, `id_mod`, `type`, `status`) VALUES
(1, 1, 1, 'module', 1),
(2, 1, 1, 'sub_module', 1),
(3, 1, 2, 'sub_module', 1),
(4, 1, 3, 'sub_module', 1),
...
--
-- Estructura de tabla para la tabla `visits_v2`
--
...
--
-- Volcado de datos para la tabla `visits_v2`
--

INSERT INTO `visits_v2` (`id`, `page`, `date_time`) VALUES
(1, 1, '1728336558790'),
(2, 1, '1728336984545'),
(3, 1, '1728337194054'),
(4, 8, '1728337227228'),
...
--
-- Indices de la tabla `afromexicana_por_municipio_v2`
--
ALTER TABLE `afromexicana_por_municipio_v2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `Id_Mun` (`Id_Mun`);

--
-- Indices de la tabla `cultura_por_municipio_v2`
--
ALTER TABLE `cultura_por_municipio_v2`
  ADD PRIMARY KEY (`Id`);

--
-- Indices de la tabla `economia_por_municipio_v2`
--
ALTER TABLE `economia_por_municipio_v2`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `Id_Mun` (`Id_Mun`);

--
-- Indices de la tabla `educacion_por_municipio_v2`
--
ALTER TABLE `educacion_por_municipio_v2`
  ADD PRIMARY KEY (`Id`);

--
-- Indices de la tabla `fuentes_informacion_v2`
--
ALTER TABLE `fuentes_informacion_v2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_mod` (`id_mod`);

--
-- Indices de la tabla `gobernanza_por_municipio_v2`
--
ALTER TABLE `gobernanza_por_municipio_v2`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `Id_Mun` (`Id_Mun`);

--
-- Indices de la tabla `infraestructura_por_municipio_v2`
--
ALTER TABLE `infraestructura_por_municipio_v2`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `Id_Mun` (`Id_Mun`);

--
-- Indices de la tabla `justicia_seguridad_por_municipio_v2`
--
ALTER TABLE `justicia_seguridad_por_municipio_v2`
  ADD PRIMARY KEY (`Id`);

--
-- Indices de la tabla `lenguas_por_municipio_v2`
--
ALTER TABLE `lenguas_por_municipio_v2`
  ADD PRIMARY KEY (`Id`);

--
-- Indices de la tabla `lenguas_v2`
--
ALTER TABLE `lenguas_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `lengua_por_municipio_v2`
--
ALTER TABLE `lengua_por_municipio_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `login_v2`
--
ALTER TABLE `login_v2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_user` (`id_user`);

--
-- Indices de la tabla `medio_ambiente_por_municipio_v2`
--
ALTER TABLE `medio_ambiente_por_municipio_v2`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `Id_Mun` (`Id_Mun`);

--
-- Indices de la tabla `migracion_por_municipio_v2`
--
ALTER TABLE `migracion_por_municipio_v2`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `Id_Mun` (`Id_Mun`);

--
-- Indices de la tabla `modules_v2`
--
ALTER TABLE `modules_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `municipios_v2`
--
ALTER TABLE `municipios_v2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `TipoMunicipio` (`TipoMunicipio`),
  ADD KEY `region` (`region`);

--
-- Indices de la tabla `pages_v2`
--
ALTER TABLE `pages_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pruebas_v2`
--
ALTER TABLE `pruebas_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `regiones_v2`
--
ALTER TABLE `regiones_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `salud_por_municipio_v2`
--
ALTER TABLE `salud_por_municipio_v2`
  ADD PRIMARY KEY (`Id`);

--
-- Indices de la tabla `sub_modules_v2`
--
ALTER TABLE `sub_modules_v2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_mod` (`id_mod`);

--
-- Indices de la tabla `tecnologia_por_municipio_v2`
--
ALTER TABLE `tecnologia_por_municipio_v2`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `Id_Mun` (`Id_Mun`);

--
-- Indices de la tabla `tiposmunicipios_v2`
--
ALTER TABLE `tiposmunicipios_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `users_v2`
--
ALTER TABLE `users_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `user_permissions_v2`
--
ALTER TABLE `user_permissions_v2`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `visits_v2`
--
ALTER TABLE `visits_v2`
  ADD PRIMARY KEY (`id`),
  ADD KEY `page` (`page`);
...
--
-- AUTO_INCREMENT de la tabla `afromexicana_por_municipio_v2`
--
ALTER TABLE `afromexicana_por_municipio_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;

--
-- AUTO_INCREMENT de la tabla `cultura_por_municipio_v2`
--
ALTER TABLE `cultura_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `economia_por_municipio_v2`
--
ALTER TABLE `economia_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `educacion_por_municipio_v2`
--
ALTER TABLE `educacion_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `fuentes_informacion_v2`
--
ALTER TABLE `fuentes_informacion_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT de la tabla `gobernanza_por_municipio_v2`
--
ALTER TABLE `gobernanza_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `infraestructura_por_municipio_v2`
--
ALTER TABLE `infraestructura_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `justicia_seguridad_por_municipio_v2`
--
ALTER TABLE `justicia_seguridad_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `lenguas_por_municipio_v2`
--
ALTER TABLE `lenguas_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `lengua_por_municipio_v2`
--
ALTER TABLE `lengua_por_municipio_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=450;

--
-- AUTO_INCREMENT de la tabla `login_v2`
--
ALTER TABLE `login_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `medio_ambiente_por_municipio_v2`
--
ALTER TABLE `medio_ambiente_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `migracion_por_municipio_v2`
--
ALTER TABLE `migracion_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `modules_v2`
--
ALTER TABLE `modules_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `municipios_v2`
--
ALTER TABLE `municipios_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;

--
-- AUTO_INCREMENT de la tabla `pages_v2`
--
ALTER TABLE `pages_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `pruebas_v2`
--
ALTER TABLE `pruebas_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `regiones_v2`
--
ALTER TABLE `regiones_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de la tabla `salud_por_municipio_v2`
--
ALTER TABLE `salud_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `sub_modules_v2`
--
ALTER TABLE `sub_modules_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `tecnologia_por_municipio_v2`
--
ALTER TABLE `tecnologia_por_municipio_v2`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT de la tabla `tiposmunicipios_v2`
--
ALTER TABLE `tiposmunicipios_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `users_v2`
--
ALTER TABLE `users_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `user_permissions_v2`
--
ALTER TABLE `user_permissions_v2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `visits_v2`
--
ALTER TABLE `visits_v2`
...
--
-- Filtros para la tabla `fuentes_informacion_v2`
--
ALTER TABLE `fuentes_informacion_v2`
  ADD CONSTRAINT `fuentes_informacion_v2_ibfk_1` FOREIGN KEY (`id_mod`) REFERENCES `modules_v2` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `gobernanza_por_municipio_v2`
--
ALTER TABLE `gobernanza_por_municipio_v2`
  ADD CONSTRAINT `gobernanza_por_municipio_v2_ibfk_1` FOREIGN KEY (`Id_Mun`) REFERENCES `municipios_v2` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `infraestructura_por_municipio_v2`
--
ALTER TABLE `infraestructura_por_municipio_v2`
  ADD CONSTRAINT `infraestructura_por_municipio_v2_ibfk_1` FOREIGN KEY (`Id_Mun`) REFERENCES `municipios_v2` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `medio_ambiente_por_municipio_v2`
--
ALTER TABLE `medio_ambiente_por_municipio_v2`
  ADD CONSTRAINT `medio_ambiente_por_municipio_v2_ibfk_1` FOREIGN KEY (`Id_Mun`) REFERENCES `municipios_v2` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `migracion_por_municipio_v2`
--
ALTER TABLE `migracion_por_municipio_v2`
  ADD CONSTRAINT `migracion_por_municipio_v2_ibfk_1` FOREIGN KEY (`Id_Mun`) REFERENCES `municipios_v2` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `municipios_v2`
--
ALTER TABLE `municipios_v2`
  ADD CONSTRAINT `municipios_v2_ibfk_1` FOREIGN KEY (`TipoMunicipio`) REFERENCES `tiposmunicipios_v2` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `municipios_v2_ibfk_2` FOREIGN KEY (`region`) REFERENCES `regiones_v2` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `sub_modules_v2`
--
ALTER TABLE `sub_modules_v2`
  ADD CONSTRAINT `sub_modules_v2_ibfk_1` FOREIGN KEY (`id_mod`) REFERENCES `modules_v2` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `tecnologia_por_municipio_v2`
--
ALTER TABLE `tecnologia_por_municipio_v2`
  ADD CONSTRAINT `tecnologia_por_municipio_v2_ibfk_1` FOREIGN KEY (`Id_Mun`) REFERENCES `municipios_v2` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `visits_v2`
--
ALTER TABLE `visits_v2`
  ADD CONSTRAINT `visits_v2_ibfk_1` FOREIGN KEY (`page`) REFERENCES `pages_v2` (`id`) ON UPDATE CASCADE;
COMMIT;
