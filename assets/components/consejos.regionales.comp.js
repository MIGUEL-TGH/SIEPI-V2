export default Vue.component('consejos_regionales_comp',{
   template://html
      `<div>
         <div style="background: #9B162E">
            <section class="container-article">  
               ...
               <!--<v-card flat elevation="15" class="card_text">
                     <h1 class="dialog_title" style="color:#302f2f"> <strong>CONFORMACIÓN DE CONSEJOS REGIONALES INDÍGENAS</strong> </h1>
                     <v-divider ></v-divider>
                     <div class="dialog_item_content" style="padding:10px">
                        <p>Con el propósito de garantizar la participación en el diseño y la toma de decisiones en los asuntos relacionados con los derechos fundamentales individuales y colectivos de las personas, pueblos y comunidades indígenas y afromexicanas del estado de Puebla, el IPPI realizó ocho asambleas generales en las regiones de la Mixteca poblana, Huehuetla, Teziutlán, Tehuacán, Zacapoaxtla, Sierra Negra, Tetela de Ocampo y Huauchinango para conformar a los Consejos Regionales Indígenas (CRIAS).</p>
                        <p>Dichos organismos están conformados por personas consejeras, quienes fueron elegidas como representantes a través de sus sistemas normativos propios y tienen la función de analizar, proponer y elaborar acciones para la elaboración de políticas públicas enfocadas en pueblos indígenas y afromexicanos.</p>
                        <p>En este sentido se contó con una participación total de 1,499 personas provenientes de los siete pueblos originarios del estado de Puebla, de los cuales 670 fueron mujeres y 829 hombres.</p>
                     </div>
               </v-card>-->
               ...
               <v-card flat elevation="15" class="card_text">
                     ...
                     <div class="dialog_item_content" style="padding:10px">
                        <p>Con el propósito de garantizar la participación en el diseño y la toma de decisiones en los asuntos
                        relacionados con los derechos fundamentales individuales y colectivos de las personas, pueblos y
                        comunidades indígenas y afromexicanas del estado de Puebla, el IPPI realizó diez asambleas
                        generales en las regiones de la Mixteca poblana, Huehuetla, Teziutlán, Tehuacán, Zacapoaxtla,
                        Sierra Negra, Tetela de Ocampo, Quimixtlán, Huauchinango y municipio de Puebla para conformar
                        a los Consejos Regionales Indígenas (CRIAS).</p>
                        <p>Dichos organismos están conformados por personas consejeras, quienes fueron elegidas como
                        representantes a través de sus sistemas normativos propios y tienen la función de analizar,
                        proponer y elaborar acciones para la elaboración de políticas públicas enfocadas en pueblos
                        indígenas y afromexicanos.</p>
                        <p>En este sentido se contó con una participación total de 1499 personas representantes de las
                        comunidades provenientes de los siete pueblos originarios del estado de Puebla, de los cuales 670
                        fueron mujeres y 829 hombres.</p>
                        <p></p>
                     </div>
               </v-card>
                           ...
                           <v-card flat color="">
                              <v-card-text class="">
                                    <div class="container-article">
                                       <!--<h2 class="dialog_title_2" style="color:#9B162E"> {{item.tab}} {{i}} </h2>-->
